  ...
  return (
    <TouchableOpacity 
      className={clsx(
        ...
        ["bg-violet-500 border-violet-400"] : amountAccomplishedPercentage >= 80 && amountAccomplishedPercentage < 80,
        ["bg-violet-300 border-violet-300"] : amountAccomplishedPercentage == 100,
